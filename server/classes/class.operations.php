...
class OperationsUtil
{
	...
	public function create($buildingInstance)
	{
	...
	public function getProfitableBuildingsList($userId)
	{
		$userId = (int)$userId;
	...
	public function findBuildingInstanceByXY($userId, $x = 0, $y = 0)
	{
		$userId = (int)$userId;
		$x = (int)$x;
		$y = (int)$y;
	...
	public function getBuildingInstanceById($buildingInstanceId)
	{
	...
	public function getBuildingInstances($userId = null)
	{
		$userId = (int)$userId;
	...
	public function removeInstance($buildingInstance)
	{
